...
//	<li>每个节点的值都是独一无二的。</li>
//</ul>
//<div><div>Related Topics</div><div><li>树</li><li>深度优先搜索</li><li>广度优先搜索</li><li>哈希表</li><li>二叉树</li></div></div><br><div><li>👍 147</li><li>👎 0</li></div>
  
package leetcode.editor.cn;

import java.util.*;

public class leetCode865_SmallestSubtreeWithAllTheDeepestNodes{
      public static void main(String[] args) {
           Solution solution = new leetCode865_SmallestSubtreeWithAllTheDeepestNodes().new Solution();
