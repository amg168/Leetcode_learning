...
//度。 
// 
// Related Topics 栈 树 设计 二叉搜索树 二叉树 迭代器 👍 542 👎 0
...
public class leetCode173_BinarySearchTreeIterator{
      public static void main(String[] args) {
          ...
          BSTIterator solution = new leetCode173_BinarySearchTreeIterator().new BSTIterator(root);
...
class BSTIterator {
    ...
    public boolean hasNext() {
        return cur != null || !inOrderStack.isEmpty();
    }
}
